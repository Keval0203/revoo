...
const getInitialFilters = (): VenueFilters => {
  ...
  const initialFilters: VenueFilters = { ...defaultFilters };
...
export function VenuesPage() {
  const [filters, setFilters] = useState<VenueFilters>(getInitialFilters);
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-background flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-red-600 dark:text-red-400">Error Loading Venues</CardTitle>
          </CardHeader>
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <Badge variant="secondary" className="px-3 py-1 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 border-emerald-200/50 dark:border-emerald-800/50">
                  <Building2 className="w-4 h-4 mr-1 text-emerald-600 dark:text-emerald-400" />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button
                  ...
                  className="whitespace-nowrap border-gray-200 dark:border-slate-700"
                >
                ...
                {/* View Mode Toggle */}
                <div className="hidden sm:flex items-center border border-gray-200 dark:border-slate-700 rounded-lg p-0.5 bg-slate-50 dark:bg-slate-900">
                  <Button
                    variant={viewMode === 'grid' ? 'default' : 'ghost'}
                    size="sm"
                    onClick={() => setViewMode('grid')}
                    className="rounded-r-none h-7 px-2.5"
                  >
                  ...
                  <Button
                    ...
                    className="rounded-l-none h-7 px-2.5"
                  >
